...
public class IFWVideoCamClientRankingv2_final extends PApplet {
...
public void draw() {
  ...
  if (accesView) {
   ...
   winner="";//mirar donde ponerlo a 0 para que no se repita siempre en el draw, funcion boolean?
    ...
    textSize(18);
    fill(0xff79fd1e);
    text(winner, width*0.80f, height*0.85f);
    text("has oppened the door", width*0.80f, height*0.90f);
    if (openDoor==true) {
...
public void drawRanking() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "IFWVideoCamClientRankingv2_final" };
    if (passedArgs != null) {
